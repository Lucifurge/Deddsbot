...
<nav>
  ...
  <div>
    <a href="/">Dashboard</a>
    <a href="https://your-second-bot-link.com">BIBLE HELPER BOT</a>
  </div>
</nav>

<header>
  <h1>BIBLE <span>ENGINE</span> BOT</h1>
  <p>Faith-centered • Multi-purpose • Live Stats</p>
</header>
...
<section class="container">
  ...
  <div class="card">
    ...
    <a class="button" href="https://discord.com/api/oauth2/authorize?client_id=YOUR_CLIENT_ID&permissions=8&scope=bot%20applications.commands">
      Invite to Discord
    </a>
  </div>
...
<footer>
  © 2026 BIBLE ENGINE BOT • Made by Dev Aether, Dev Luke, Dev Zap
</footer>
